...
export default function Instagram() {
  return (
    <div className="w-full max-h-xl max-w-md mx-auto">
      <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-pink-400 via-blue-500 to-teal-400 p-1">
        <div className="bg-white/10 backdrop-blur-sm rounded-t-2xl px-4 py-2 flex items-center space-x-2">
          <InstagramIcon className="w-4 h-4 text-white" />
          <span className="text-xs font-medium text-white">Instagram post</span>
        </div>
